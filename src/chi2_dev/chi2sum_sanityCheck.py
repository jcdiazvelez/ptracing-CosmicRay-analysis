...
chi2sum = load_chi2_from_npz(file_maps_dir+"chi2_realmap_pwrind-2p6_all-wei_nside32_pix1_dof10_wo-gaussian.npz")
...
# Plot the values
plot_chi2_vs_pixel(chi2sum, title="Chi² value per HEALPix pixel")
