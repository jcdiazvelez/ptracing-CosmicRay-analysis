...
import numpy as np
import healpy as hp
from data_methods_v2 import process_particle_data_equatorial_coord
...
direction_data = pool.starmap(process_particle_data_equatorial_coord, pool_input)
direction_data = np.array([ent for sublist in direction_data for ent in sublist])

# Save produced data
prefix = 'eq_coord_norm_nside=' + str(nside)
